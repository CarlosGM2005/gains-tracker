...
export class RecordsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.ejercicios = [
      { id: 1, nombre: "Jalón al Pecho", imagen: "https://placehold.co/67x67", series: [{ dia: "2025-04-10", numero: 1, repeticiones: 12, peso: 45, descanso: 60 }, { dia: "2025-04-10", numero: 2, repeticiones: 12, peso: 45, descanso: 60 }], isOpen: false },
